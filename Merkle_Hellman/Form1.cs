...
namespace Merkle_Hellman
{
    ...
    {
        public delegate void UpdateTextBoxDelegate(string textBoxString, Color color);
        public UpdateTextBoxDelegate UpdateTextBox;
        public MerkleHellmanCore MerkleHellmanClassCore;
        ...
        public Form1()
        {
            ...
            MerkleHellmanClassCore = new MerkleHellmanCore(this);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var h = MerkleHellmanClassCore.CalculateHardknapsacks(s, w, n);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(textBox5.Text))
                {
                    ...
                    h = MerkleHellmanClassCore.CalculateHardknapsacks(s, w, n);
                ...
                var enc = MerkleHellmanClassCore.EncryptMessage(h, textBox6.Text.Replace(" ", ""));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    wi = MerkleHellmanClassCore.CalculateWinvers(w, n);
                }
                else
                {
                ...
                var messge = MerkleHellmanClassCore.DecryptMessage(msg, wi, n, s);
                var str = "";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                var w = Convert.ToInt32(textBox2.Text);
                var n = Convert.ToInt32(textBox3.Text);
                var wi = MerkleHellmanClassCore.CalculateWinvers(w, n);
                textBox8.Text = wi.ToString();
            }
            catch (Exception exception)
            {
